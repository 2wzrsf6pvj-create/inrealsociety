...
function MigrateContent() {
  ...
  if (!memberId) {
    return (
      <p className="font-ui text-sm text-brand-gray/40 text-center">
  ...
  if (done) {
    return (
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <h2 className="font-display text-3xl font-light tracking-[0.06em]">Vérifiez votre email.</h2>
  ...
  return (
    <div className="w-full flex flex-col gap-6">
      <div className="text-center flex flex-col gap-2">
        <h2 className="font-display text-3xl font-light tracking-[0.06em]">Sécurisez votre profil.</h2>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1">
          <label className="font-ui text-xs text-brand-gray/30 tracking-[0.2em] uppercase">Confirmer</label>
