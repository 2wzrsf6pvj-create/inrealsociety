  ...
  if (sent) {
    return (
      <main className="relative flex min-h-screen flex-col items-center justify-center bg-brand-black text-brand-white px-6 overflow-hidden">
        <div className="z-10 flex flex-col items-center w-full max-w-xs md:max-w-sm gap-8 text-center animate-stagger-1">
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center bg-brand-black text-brand-white px-6 overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center w-full max-w-xs md:max-w-sm gap-9">
        ...
        <Link
          href="/auth/login"
          className="font-ui text-sm text-brand-gray/30 tracking-[0.15em] uppercase underline underline-offset-4 hover:text-brand-white transition-colors animate-stagger-3"
        >
          ← Retour à la connexion
        </Link>
