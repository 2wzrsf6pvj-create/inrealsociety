    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center bg-brand-black text-brand-white px-6">
      <div className="z-10 flex flex-col items-center text-center gap-6 w-full max-w-xs">
        ...
        <div className="flex flex-col gap-2">
          <p className="font-display text-[1.4rem] font-light">Ce profil est temporairement indisponible.</p>
          <p className="font-ui text-[0.55rem] text-brand-gray/30 leading-relaxed">Une erreur est survenue. Réessayez dans quelques instants.</p>
        </div>
