      ...
      <div className="z-10 flex flex-col items-center text-center gap-8 w-full max-w-xs md:max-w-sm">
        ...
        <div className="relative flex items-center justify-center animate-stagger-1">
          ...
          <div className="w-[72px] h-[72px] rounded-full border border-brand-white/20 flex items-center justify-center">
            <span className="font-display text-3xl font-light tracking-[0.05em] opacity-40">X</span>
          </div>
        </div>

        <div className="flex flex-col gap-3 animate-stagger-2">
          <p className="font-ui text-xs text-brand-gray/40 tracking-[0.3em] uppercase">
            Erreur 404
          </p>
